...
const Nav = () => {
    ...
    return (
        <div className="nav">
            ...
            <div className="nav-link" onClick={() => history.push("/community")}>
                <span className="fas fa-user-friends"></span>
                <span className="nav-label">Community</span>
            </div>

            <div className="nav-link" onClick={() => history.push("/chat")}>
                <span className="fas fa-envelope"></span>
                <span className="nav-label">Chat</span>
            </div>

            <div className="nav-link" onClick={() => history.push("/saved")}>
                <span className="fas fa-bookmark"></span>
                <span className="nav-label">Saved</span>
            </div>
            <div className="nav-link" onClick={() => history.push("/profile")}>
